...
This manual describes the functionality of the tool's main layers: the landing page at https://actdev.cyipt.bike, the site level web application which is available at [actdev.cyipt.bike/sites/](https://actdev.cyipt.bike/sites/), and the A/B Street traffic simulation tool.
