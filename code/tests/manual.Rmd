...
The figure below shows the busyness of the roads in the fast cycle route network, in zones around Handforth Garden Village.  

```{r}
knitr::include_graphics("https://user-images.githubusercontent.com/361423/110861560-3af92f80-82b6-11eb-9a49-1725cac32b23.png")
```
