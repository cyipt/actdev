...
Nationally, access to a range of services has been quantified through the Department for Transport's Journey Time Statistics.
<!-- (link).  -->
...
We developed new methods to 'disaggregate' origin-destination data, enabling a greater diversity of destinations within a single MSOA zone, as illustrated in the figure below.
<!-- todo: Needs caption - RL. -->
...
For cycle journeys to work, we used a set of algorithms created by CycleStreets.net.
<!-- Todo: add link -->
...
To generate the increased cycle uptake in Go Active, we used the 'Go Dutch' cycling uptake function from the Propensity to Cycle Tool.
<!-- Todo: add reference. -->
