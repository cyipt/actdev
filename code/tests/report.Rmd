...
Most of the chosen sites will have over 1000 homes on completion, but some are smaller, the smallest being Micklefield with xxx.

Unsurprisingly, existing travel patterns in the locality of these sites vary greatly.
The variation in commuter journeys is captured by the data in our Baseline scenario. 
Walking mode share for these journeys varies from x in x to x in x, with a mean of x.
Cycling mode share...
Driving mode share...
Other modes...

Mean journey distances
