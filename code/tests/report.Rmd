...
We can see that walking and cycling mostly occurs in the shorter distance bands, and these short journeys comprise a higher proportion of total commutes at Great Kneighton than they do at Chapelford.

Commute mode and distance breakdowns - infographics
...
The mean distance from our case study sites to the nearest town centre is 3.2 km.
Eleven sites lie within 2.0 km of the nearest town centre.
At five sites the nearest town centre is >5.0 km away, the longest being Aylesham with a distance of 9.2 km. 
...
Currently using Euclidean distance, should use route distance.

Distance to town centre - histogram

## Potential improvements for active travel - The Go Active scenario

Assuming existing travel patterns remain the same, in terms of the locations of workplaces or other destinations, a key question is what proportion of these journeys could switch from car/van driving to walking or cycling? 
...
Commutes by bicycle in the Go Active scenario range from 5% at Ashton Park and Tresham to 63% at Great Kneighton in Cambridge.
...
Differences within and between sites - infographic to compare with previous one

Infographic with baseline and Go Active mode share alongside one another:
```{r}
...
knitr::include_graphics("../../data-small/great-kneighton/mode-split-goactive.png")
```
