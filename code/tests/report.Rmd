...
Distance to town centre - histogram (but some smaller towns missing from the dataset)
...
Why do some sites see greater change than other sites? (% of short journeys? % who travel by other modes?)
